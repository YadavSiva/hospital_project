...
import { deleteDoctor, getDoctor } from '../../service/doctor.service';
...
export function AdmindoctorComponent() {
    ...
    function editpropertytype(value) {
        nameref.current.value = value.name
         ...
         departmentref.current.value = value.department
    ...
    return (
        <div>
            ...
            <form  method="post" action="http://localhost:4005/savedoctor/">
                <div>
            ...
            <div className="row">
                ...
                <div className="col-10">
                    <input
                        type="text" className="form-control" id="department" name='department' ref={departmentref}></input>
            ...
            <div className='m-3' ><GridComponent
                ...
                deletRecord={(value)=>{deleteDoctorItem(value)}}
            ></GridComponent></div>
            </form>
        </div>
    )
