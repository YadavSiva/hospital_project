...
import { deleteNurse, getNurse } from '../../service/nurse.service';
...
export function NurseComponent() {
    ...
    function deleteNurseItem(value) {
    ...
    return (
        <div>
            ...
            <form  method="post" action="http://localhost:4005/saveNurse/">
                <div>
            ...
            <div className='m-3' ><GridComponent
                ...
                headers={gridheader}
                body={gridbody}
                editItemFromGrid={(value) => { editNurseItem(value) }}
                deletRecord={(value)=>{deleteNurseItem(value)}}
            ></GridComponent></div>
            </form>
        </div>
    )
