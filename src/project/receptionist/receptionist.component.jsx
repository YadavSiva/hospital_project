...
import { deleteReceptionist, getReceptionist } from '../../service/receptionist.service';
...
export function ReceptionistComponent() {
    ...
    function deleteRecetionist(value) {
    ...
    return (
        <div>
            ...
            <h3 style={{ margin: "20px 0px", color: "#818da1", fontWeight: "200px" }}>
                            <ArrowRightCircle></ArrowRightCircle>&nbsp;Recetionist </h3>
            <form  method="post" action="http://localhost:4005/saveRecetionist/">
                <div>
            ...
            <div className="row mt-3">
                ...
                <div className="col-10">
                    <textarea
                        type="text" className="form-control" id="address" name='address' ref={addressref}></textarea>
            ...
            <div className='m-3' ><GridComponent
                ...
                deletRecord={(value)=>{deleteRecetionist(value)}}
            ></GridComponent></div>
            </form>
        </div>
    )
